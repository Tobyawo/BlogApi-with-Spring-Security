...
//                .antMatchers("admin/api/v1/**").hasAnyRole(ADMIN.name(), ADMINTRAINEE.name()) //role based authentication
...
////        auth.authenticationProvider(daoAuthenticationProvider()); // for in-memory configuration
//        auth.jdbcAuthentication(); // for database configuration
//    }
//
//    @Bean
